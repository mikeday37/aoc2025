...
test(lambda: solve_part(_example, is_invalid_part_1), 1227775554)
test(lambda: solve_part(_example, is_invalid_part_2), 4174379265)

test(lambda: solve_part(_input, is_invalid_part_1), 17077011375)
test(lambda: solve_part(_input, is_invalid_part_2), 36037497037)
